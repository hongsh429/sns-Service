...
public class UserControllerTest {
    ...
    public void 회원가입_실패_중복된아이디() throws Exception {
        ...
        when(userService.join(username, password)).thenThrow(new CustomException(ErrorCode.DUPLICATED, ""));
    ...
    public void 로그인_실패_회원가입_안된_username() throws Exception {
        ...
        when(userService.login(username, password)).thenThrow(new CustomException(ErrorCode.NO_DATA, ""));
    ...
    public void 로그인_실패_password_잘못_입력() throws Exception {
        ...
        when(userService.login(username, password)).thenThrow(new CustomException(ErrorCode.INVALID_DATA, ""));
